                    ...
                    <div class="divide-y divide-gray-700" x-data="{active: null}">
                        ...
                        <div class="py-4">
                            <button @click="active !== 0 ? active = 0 : active = null" class="flex justify-between items-center w-full focus:outline-none">
                                <h4 class="text-lg font-medium text-white">What is <?php echo e($settings->site_name); ?>?</h4>
                        ...
                        <div class="py-4">
                            <button @click="active !== 1 ? active = 1 : active = null" class="flex justify-between items-center w-full focus:outline-none">
                                <h4 class="text-lg font-medium text-white">Is <?php echo e($settings->site_name); ?> an officially registered company?</h4>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <p>Click the Register button. Enter your details to quickly create a FREE <?php echo e($settings->site_name); ?> account.</p>
                                        </div>
                                    </div>
                                    <div class="flex items-start">
                                        <div class="flex-shrink-0 h-8 w-8 rounded-full bg-blue-600 flex items-center justify-center mr-3">
                ...
                <div class="p-6 md:p-8">
                    <div class="divide-y divide-gray-700" x-data="{active: null}">
                        ...
                        <div class="py-4">
                            ...
                            <div x-show="active === 1" x-collapse x-cloak class="mt-3">
                                <p class="text-gray-300"><?php echo e($settings->site_name); ?> offers a unique investment and referral program that rewards you not only for partners who came from you to the platform, but also for partners from levels 2,3 and 4. This unique affiliate program brings you passive referral income.</p>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/check.elitemaxpro.click/resources/views/home/faq.blade.php ENDPATH**/ ?>