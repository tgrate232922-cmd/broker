...
<?php $__env->startSection('title', 'Email Verification - Secure Your Trading Account'); ?>
                ...
                <div class="mb-6 p-4 bg-green-500/10 border border-green-500/20 rounded-xl">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="text-sm">
                            ...
                            <p class="text-gray-300"><?php echo e(session('message')); ?></p>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.guest1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lumenvestasset/public_html/resources/views/auth/verify-email.blade.php ENDPATH**/ ?>