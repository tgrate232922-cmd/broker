          ...
          <tr>
            <td class="px" style="padding:18px 22px;border-bottom:1px solid <?php echo e($stroke2); ?>;
              ...
              <p style="margin:10px 0 0;line-height:1.7;font-size:14px;color:<?php echo e($muted); ?>;">
                Hi <?php echo e($fullName); ?>, <br><?php echo e($lead); ?>
                  ...
                  <td style="padding:16px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        ...
                        <td align="right" style="color:<?php echo e($muted2); ?>;font-size:13px;font-weight:800;">
                          Stake:
                          <span class="mono" style="color:<?php echo e($text); ?>;font-weight:900;">
                            <?php echo e($amt); ?> <?php echo e($asset); ?>
                      ...
                      <?php if(!empty($network) && $network !== '—'): ?>
                      <tr>
                        <td colspan="2" style="padding-top:10px;color:<?php echo e($muted2); ?>;font-size:12px;">
                          Network: <span class="mono" style="color:<?php echo e($text); ?>;font-weight:800;"><?php echo e($network); ?></span>
                        </td>
                      </tr>
                      <?php endif; ?>
                    </table>
            ...
            <td class="px" style="padding:10px 22px 18px 22px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                ...
                <tr>
                  ...
                  <td style="padding:14px 14px;border-bottom:1px solid <?php echo e($stroke2); ?>;color:<?php echo e($text); ?>;font-weight:900;font-size:13px;">
                    <span class="mono"><?php echo e($joinedText); ?></span>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td style="padding:14px 14px;color:<?php echo e($text); ?>;font-weight:900;font-size:13px;">
                    <span class="mono"><?php echo e($unlockText); ?></span>
                  </td>
                </tr>

                <?php if(!empty($aprText) || !empty($epochText) || !empty($rewardsText) || !empty($votePowerText)): ?>
                  <tr>
                    <td colspan="2" style="padding:0;">
                      <div style="height:1px;background:<?php echo e($stroke2); ?>;"></div>
                    </td>
                  </tr>
                <?php endif; ?>

                <?php if(!empty($aprText)): ?>
                <tr>
                  <td style="padding:14px 14px;border-bottom:1px solid <?php echo e($stroke2); ?>;color:<?php echo e($muted2); ?>;font-size:12px;font-weight:800;">
                    Pool APR
                  </td>
                  <td style="padding:14px 14px;border-bottom:1px solid <?php echo e($stroke2); ?>;color:<?php echo e($text); ?>;font-weight:900;font-size:13px;">
                    <span class="mono"><?php echo e($aprText); ?></span>
                  </td>
                </tr>
                <?php endif; ?>

                <?php if(!empty($epochText)): ?>
                <tr>
                  <td style="padding:14px 14px;border-bottom:1px solid <?php echo e($stroke2); ?>;color:<?php echo e($muted2); ?>;font-size:12px;font-weight:800;">
                    Epoch
                  </td>
                  <td style="padding:14px 14px;border-bottom:1px solid <?php echo e($stroke2); ?>;color:<?php echo e($text); ?>;font-weight:900;font-size:13px;">
                    <span class="mono"><?php echo e($epochText); ?></span>
                  </td>
                </tr>
                <?php endif; ?>

                <?php if(!empty($rewardsText)): ?>
                <tr>
                  <td style="padding:14px 14px;border-bottom:1px solid <?php echo e($stroke2); ?>;color:<?php echo e($muted2); ?>;font-size:12px;font-weight:800;">
                    Rewards
                  </td>
                  <td style="padding:14px 14px;border-bottom:1px solid <?php echo e($stroke2); ?>;color:<?php echo e($text); ?>;font-weight:900;font-size:13px;">
                    <span class="mono"><?php echo e($rewardsText); ?></span>
                  </td>
                </tr>
                <?php endif; ?>

                <?php if(!empty($votePowerText)): ?>
                <tr>
                  <td style="padding:14px 14px;color:<?php echo e($muted2); ?>;font-size:12px;font-weight:800;">
                    Voting power
                  </td>
                  <td style="padding:14px 14px;color:<?php echo e($text); ?>;font-weight:900;font-size:13px;">
                    <span class="mono"><?php echo e($votePowerText); ?></span>
                  </td>
                </tr>
                <?php endif; ?>
              </table>
...
</html><?php /**PATH /home/homefor1/scalpchain.com/account/resources/views/emails/investment/event.blade.php ENDPATH**/ ?>