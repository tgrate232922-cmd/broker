...
<?php endif; ?>
        ...
        <div class="bg-gray-900 border border-gray-700 rounded-2xl shadow-xl max-w-3xl mx-auto">
            ...
            <div class="p-6 border-b border-gray-700 flex items-center gap-4">
                ...
                <div>
                    <h3 class="text-xl font-semibold text-white">
                        <?php echo e($payment_mode); ?> Withdrawal
                    </h3>
            ...
            <!-- Form -->
            <form method="POST"
                  action="<?php echo e(route('completewithdrawal')); ?>"
                  id="withdrawalForm"
                  class="p-6 space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-300 mb-2">
                        Withdrawal Amount (<?php echo e(Auth::user()->currency); ?>)
                    </label>
                    ...
                    <p class="text-xs text-gray-400 mt-2">
                        Available balance:
                        <?php echo e(Auth::user()->currency); ?>

                        <?php echo e(number_format(Auth::user()->account_bal, 2)); ?>
        ...
        <div class="max-w-3xl mx-auto mt-6 bg-gray-900 border border-gray-700 rounded-xl p-6">
            ...
            <ul class="space-y-2 text-sm text-gray-300">
                ...
                <li>• Minimum withdrawal: <?php echo e(Auth::user()->currency); ?>50</li>
                <li>• Flat withdrawal fee: <?php echo e(Auth::user()->currency); ?>5</li>
            </ul>
        </div>
    </div>
    ...
    <div x-show="showConfirmModal"
        ...
        <div class="bg-gray-900 rounded-2xl p-6 max-w-md w-full text-center">
            ...
            <p class="text-gray-400 mb-6">
                Withdraw <?php echo e(Auth::user()->currency); ?><span x-text="amount"></span>
                via <?php echo e($payment_mode); ?>?
            </p>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/homefor1/scalpchain.com/account/resources/views/user/withdraw.blade.php ENDPATH**/ ?>