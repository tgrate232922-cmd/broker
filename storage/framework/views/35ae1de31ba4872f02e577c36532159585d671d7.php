                ...
                <script type="application/ld+json">
                    {
                        ...
                        "itemListElement": [
                            ...
                            },
                            {
                                ...
                                "position": 2,
                                "item": {
                                    "@id": "<?php echo e($settings->site_address); ?>trading",
                                    "name": "Trading"
                                }
                            }
                        ]
                ...
                <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <div class="text-center md:text-left">
                        ...
                        <div class="flex items-center justify-center md:justify-start space-x-4">
                            <a href="mailto:<?php echo e($settings->contact_email); ?>" class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-700 hover:bg-gray-600 transition-colors duration-300">
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/check.elitemaxpro.click/resources/views/home/shares.blade.php ENDPATH**/ ?>