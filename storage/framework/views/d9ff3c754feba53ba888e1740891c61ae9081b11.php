...
} elseif ($_instance->childHasBeenRendered('pUwKwYi')) {
    $componentId = $_instance->getRenderedChildComponentId('pUwKwYi');
    $componentTag = $_instance->getRenderedChildComponentTagName('pUwKwYi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pUwKwYi');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('pUwKwYi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/elitemaxpro/check.elitemaxpro.click/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>