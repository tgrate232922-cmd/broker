    ...
    <div x-show="showDeleteModal"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-md mx-auto shadow-xl transform transition-all duration-300"
            ...
            <div class="flex justify-center gap-3">
                ...
                <form method="POST" action="<?php echo e(route('notifications.delete')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/homefor1/scalpchain.com/account/resources/views/user/notifications/show.blade.php ENDPATH**/ ?>