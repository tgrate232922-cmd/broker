...
} elseif ($_instance->childHasBeenRendered('pfVEQ2Q')) {
    $componentId = $_instance->getRenderedChildComponentId('pfVEQ2Q');
    $componentTag = $_instance->getRenderedChildComponentTagName('pfVEQ2Q');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pfVEQ2Q');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('pfVEQ2Q', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/homefor1/scalpchain.com/account/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>