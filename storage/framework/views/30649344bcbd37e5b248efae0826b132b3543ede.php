...
} elseif ($_instance->childHasBeenRendered('kJEFsGH')) {
    $componentId = $_instance->getRenderedChildComponentId('kJEFsGH');
    $componentTag = $_instance->getRenderedChildComponentTagName('kJEFsGH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kJEFsGH');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('kJEFsGH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/lumenvestasset/demo.lumenvestasset.com/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>