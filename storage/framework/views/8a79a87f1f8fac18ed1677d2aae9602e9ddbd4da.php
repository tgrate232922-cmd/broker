        ...
        Dashboard
                ...
                <li>
                    <a href="<?php echo e(route('accounthistory')); ?>"
                       class="flex items-center px-3 py-2 text-[17px] md:text-base text-gray-700 dark:text-gray-200 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/50 transition-colors duration-150 <?php echo e(request()->routeIs('accounthistory') ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 font-semibold' : ''); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('mplans')); ?>"
                       class="flex items-center px-3 py-2 text-[17px] md:text-base text-gray-700 dark:text-gray-200 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/50 transition-colors duration-150 <?php echo e(request()->routeIs('user.plans.*') ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 font-semibold' : ''); ?>">
                  ...
                  <li>
                    <a href="<?php echo e(route('myplans', 'All')); ?>"
                       class="flex items-center px-3 py-2 text-[17px] md:text-base text-gray-700 dark:text-gray-200 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/50 transition-colors duration-150 <?php echo e(request()->routeIs('myplans') ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 font-medium' : ''); ?>">
                  ...
                  <li>
                    <a href="<?php echo e(route('copy.dashboard')); ?>"
                       class="group relative flex items-center px-3 py-2 text-[17px] md:text-base text-gray-700 dark:text-gray-200 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/50 transition-colors duration-150 <?php echo e(request()->routeIs('copy.*') ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 font-semibold' : ''); ?>">
                 ...
                 <li>
                    <a href="<?php echo e(route('deposits')); ?>"
                       class="flex items-center px-3 py-2 text-[17px] md:text-base text-gray-700 dark:text-gray-200 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/50 transition-colors duration-150 <?php echo e(request()->routeIs('deposits') ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 font-semibold' : ''); ?>">
                 ...
                 <li>
                    <a href="<?php echo e(route('withdrawalsdeposits')); ?>"
                       class="flex items-center px-3 py-2 text-[17px] md:text-base text-gray-700 dark:text-gray-200 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/50 transition-colors duration-150 <?php echo e(request()->routeIs('withdrawalsdeposits') ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 font-semibold' : ''); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('profile')); ?>"
                       class="flex items-center px-3 py-2 text-[17px] md:text-base text-gray-700 dark:text-gray-200 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/50 transition-colors duration-150 <?php echo e(request()->routeIs('profile') ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 font-semibold' : ''); ?>">
                    ...
                    <?php else: ?>
                        ...
                        <div class="relative">
                            <button @click="kycOpen = !kycOpen"
                                    class="flex items-center w-full px-3 py-2 text-[17px] md:text-base text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-200 <?php echo e(request()->routeIs('account.verify') ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 font-semibold' : ''); ?>">
                ...
                <?php endif; ?>
                 <li>
                    <a href="<?php echo e(route('referuser')); ?>"
                       class="group relative flex items-center px-3 py-2 text-[17px] md:text-base text-gray-700 dark:text-gray-200 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/50 transition-colors duration-150 <?php echo e(request()->routeIs('referuser') ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 font-semibold' : ''); ?>">
                ...
                <li>
                    <a href="<?php echo e(route('support')); ?>"
                       class="group relative flex items-center px-3 py-2 text-[17px] md:text-base text-gray-700 dark:text-gray-200 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/50 transition-colors duration-150 <?php echo e(request()->routeIs('support') ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400 font-semibold' : ''); ?>">
...
_smartsupp.key = 'a3822ed04b989ab477bc19ad63f714b5dc1c7776';
...
<div class="fixed bottom-0 w-full z-30 md:hidden" x-data="{ fabOpen: false }" x-cloak>
 ...
 <a href="<?php echo e(route('myplans', 'All')); ?>"
  ...
  <div class="p-2 rounded-xl transition-all duration-300 ease-out
              <?php echo e(request()->routeIs('myplans')
...
<?php /**PATH /home/homefor1/scalpchain.com/account/resources/views/layouts/dasht.blade.php ENDPATH**/ ?>