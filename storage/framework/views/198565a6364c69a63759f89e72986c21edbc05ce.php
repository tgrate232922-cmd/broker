    ...
    <div class="container mx-auto px-4 md:px-6">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 md:mb-8 gap-4">
            <div class="flex items-center gap-3 md:gap-4">
                ...
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Monitor Your Positions</h1>
                    <p class="text-sm md:text-base text-gray-600 dark:text-gray-400 mt-1">Track your staking positions and rewards in your dashboard</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                        ...
                        <div class="bg-gray-800 dark:bg-gray-700/50 rounded-xl p-4 border border-gray-700 dark:border-gray-600">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="min-w-0 flex-1">
                                    <p class="text-sm text-gray-300 dark:text-gray-400">Stake Amount</p>
                        ...
                        <div class="bg-gray-800 dark:bg-gray-700/50 rounded-xl p-4 border border-gray-700 dark:border-gray-600">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="min-w-0 flex-1">
                                    <p class="text-sm text-gray-300 dark:text-gray-400">Yield Accrued</p>
                        ...
                        <div class="bg-gray-800 dark:bg-gray-700/50 rounded-xl p-4 border border-gray-700 dark:border-gray-600">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="min-w-0 flex-1">
                                    <p class="text-sm text-gray-300 dark:text-gray-400">Total Yield Accrued</p>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center gap-3 md:gap-4">
                                ...
                                <div class="min-w-0 flex-1">
                                    <p class="text-sm text-gray-300 dark:text-gray-400">Lock Period</p>
                            ...
                            <div class="flex items-center gap-3 md:gap-4">
                                ...
                                <div class="min-w-0 flex-1">
                                    <p class="text-sm text-gray-300 dark:text-gray-400">Pool Start</p>
                            ...
                            <div class="flex items-center gap-3 md:gap-4">
                                ...
                                <div class="min-w-0 flex-1">
                                    <p class="text-sm text-gray-300 dark:text-gray-400">Pool End</p>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center gap-3 md:gap-4">
                                ...
                                <div class="min-w-0 flex-1">
                                    <p class="text-sm text-gray-300 dark:text-gray-400">Yield Distribution:</p>
                            ...
                            <div class="flex items-center gap-3 md:gap-4">
                                ...
                                <div class="min-w-0 flex-1">
                                    <p class="text-sm text-gray-300 dark:text-gray-400">Minimum Guaranteed Yield</p>
                            ...
                            <div class="bg-gray-800 dark:bg-gray-700 p-4 border-b border-gray-700 dark:border-gray-600 last:border-b-0">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="font-medium text-white dark:text-white text-sm">Pool Yield</p>
                                    ...
                                    <tr class="hover:bg-gray-800 dark:hover:bg-gray-700/50 transition-colors">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <span class="font-medium text-white dark:text-white">Pool Yield
                                            </div>
                                        </td>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/homefor1/scalpchain.com/account/resources/views/user/plandetails.blade.php ENDPATH**/ ?>