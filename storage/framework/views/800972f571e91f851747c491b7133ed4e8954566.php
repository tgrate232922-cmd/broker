...
} elseif ($_instance->childHasBeenRendered('n1VdIGj')) {
    $componentId = $_instance->getRenderedChildComponentId('n1VdIGj');
    $componentTag = $_instance->getRenderedChildComponentTagName('n1VdIGj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('n1VdIGj');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('n1VdIGj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/kriprand/radexchain.com/account/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>