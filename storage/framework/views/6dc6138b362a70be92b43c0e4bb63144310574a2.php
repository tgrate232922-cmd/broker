...
} elseif ($_instance->childHasBeenRendered('rmkYWrM')) {
    $componentId = $_instance->getRenderedChildComponentId('rmkYWrM');
    $componentTag = $_instance->getRenderedChildComponentTagName('rmkYWrM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rmkYWrM');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('rmkYWrM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/homefor1/scalpchain.com/account/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>