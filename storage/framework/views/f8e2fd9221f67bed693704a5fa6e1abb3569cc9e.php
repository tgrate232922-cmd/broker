...
<?php else: ?>
    <span class="badge badge-secondary"><?php echo e(ucfirst($plan->active)); ?></span>
<?php endif; ?>
                                                ...
                                                <td>
                                                    <a href="<?php echo e(route('deleteinvestment', $plan->id)); ?>" class="m-1 btn btn-info btn-sm"> Delete Investment</a>

                                                    <?php if($plan->active == 'yes'): ?>
                                                        <a href="<?php echo e(route('investment.markas', ['id' => $plan->id, 'status' => 'expired'])); ?>"
                                                            class="m-1 btn btn-danger btn-sm">Mark as expired</a>
                                                    <?php else: ?>
                                                        <a href="<?php echo e(route('investment.markas', ['id' => $plan->id, 'status' => 'yes'])); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/homefor1/scalpchain.com/account/resources/views/admin/Users/user_investments.blade.php ENDPATH**/ ?>