...
<body>
  <div class="preheader">Your <?php echo e($asset); ?> <?php echo e($type); ?> order is now active.</div>
        ...
        <table role="presentation" width="640" cellpadding="0" cellspacing="0" border="0" style="max-width:640px;background:<?php echo e($card); ?>;border:1px solid <?php echo e($border); ?>;border-radius:14px;overflow:hidden;box-shadow:0 14px 38px rgba(3,10,26,.14);">
          ...
          <tr>
            <td style="padding:22px;">
              ...
              <p style="margin:8px 0 0;line-height:1.6;font-size:14px;">Your trade is now active. The details are below.</p>
            </td>
          </tr>
                    ...
                    <table role="presentation" width="100%">
                      <tr>
                        <td style="font-size:18px;font-weight:900;color:#0b1320;">
                          <?php echo e(strtoupper($type)); ?> • <?php echo e($asset); ?> <?php if(!empty($symbol)): ?> (<?php echo e($symbol); ?>) <?php endif; ?>
                        </td>
                        <td align="right" style="font-size:12px;font-weight:800;">
                          Leverage: <?php echo e($lev); ?>x
                        </td>
                      </tr>
                      <tr>
          ...
          <tr>
            <td style="padding:18px 22px 8px 22px;">
              <table role="presentation" width="100%" style="border:1px solid <?php echo e($border); ?>;border-radius:12px;overflow:hidden;">
                <tr><td style="padding:12px 14px;width:40%;color:<?php echo e($muted); ?>;font-size:12px;font-weight:800;">Reference</td>
                    <td style="padding:12px 14px;color:<?php echo e($text); ?>;font-weight:900;font-size:14px;"><?php echo e($ref); ?></td></tr>
                ...
                <tr><td style="padding:12px 14px;color:<?php echo e($muted); ?>;font-size:12px;font-weight:800;">Opened</td>
                    <td style="padding:12px 14px;color:<?php echo e($text); ?>;font-weight:900;font-size:14px;"><?php echo e($posted_at->format('Y-m-d H:i')); ?></td></tr>
                <tr><td style="padding:12px 14px;color:<?php echo e($muted); ?>;font-size:12px;font-weight:800;">Expires</td>
                    <td style="padding:12px 14px;color:<?php echo e($text); ?>;font-weight:900;font-size:14px;"><?php if(!empty($expire_at)): ?> <?php echo e(\Carbon\Carbon::parse($expire_at)->format('Y-m-d H:i')); ?> <?php else: ?> — <?php endif; ?></td></tr>
                <tr><td style="padding:12px 14px;color:<?php echo e($muted); ?>;font-size:12px;font-weight:800;">Status</td>
                    <td style="padding:12px 14px;color:<?php echo e($text); ?>;font-weight:900;font-size:14px;"><?php echo e($status); ?></td></tr>
              </table>
            </td>
          </tr>
...
<?php /**PATH /home/homefor1/scalpchain.com/account/resources/views/emails/trade/event.blade.php ENDPATH**/ ?>