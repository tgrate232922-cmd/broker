...
} elseif ($_instance->childHasBeenRendered('wA9uahm')) {
    $componentId = $_instance->getRenderedChildComponentId('wA9uahm');
    $componentTag = $_instance->getRenderedChildComponentTagName('wA9uahm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wA9uahm');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('wA9uahm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lumenvestasset/public_html/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>