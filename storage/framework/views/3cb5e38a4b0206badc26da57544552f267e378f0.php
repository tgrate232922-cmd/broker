...
<body>
  <div class="preheader">
    Withdrawal update: <?php echo e($amt); ?> <?php echo e($currencySafe); ?> — <?php echo e($statusLabel); ?>.
  </div>
          ...
          <tr>
            <td class="px" style="padding:18px 22px;border-bottom:1px solid <?php echo e($stroke2); ?>;
              ...
              <p style="margin:10px 0 0;line-height:1.7;font-size:14px;color:<?php echo e($muted); ?>;">
                Hi <?php echo e($fullName); ?>, this message confirms an update to your withdrawal request.
              </p>
            </td>
          </tr>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                ...
                <tr>
                  <td style="padding:16px;text-align:center;">
                    <div style="color:<?php echo e($muted2); ?>;font-size:12px;font-weight:800;letter-spacing:.2px;">REQUESTED AMOUNT</div>
                    <div style="margin-top:8px;color:<?php echo e($text); ?>;font-size:38px;font-weight:900;letter-spacing:.2px;">
                      <?php echo e($amt); ?> <span style="font-size:14px;color:<?php echo e($muted2); ?>;font-weight:800;"><?php echo e($currencySafe); ?></span>
                    </div>
          ...
          <tr>
            <td class="px" style="padding:10px 22px 18px 22px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                ...
                <tr>
                  <td style="padding:14px 14px;border-bottom:1px solid <?php echo e($stroke2); ?>;color:<?php echo e($muted2); ?>;font-size:12px;font-weight:800;">Fees</td>
                  <td style="padding:14px 14px;border-bottom:1px solid <?php echo e($stroke2); ?>;color:<?php echo e($text); ?>;font-weight:900;font-size:13px;">
                    <?php echo e($fee); ?> <?php echo e($currencySafe); ?>

                  </td>
                </tr>
                <tr>
                  <td style="padding:14px 14px;border-bottom:1px solid <?php echo e($stroke2); ?>;color:<?php echo e($muted2); ?>;font-size:12px;font-weight:800;">Total to deduct</td>
                  <td style="padding:14px 14px;border-bottom:1px solid <?php echo e($stroke2); ?>;color:<?php echo e($text); ?>;font-weight:900;font-size:13px;">
                    <?php echo e($total); ?> <?php echo e($currencySafe); ?>
                ...
                <tr>
                  <td style="padding:14px 14px;border-bottom:1px solid <?php echo e($stroke2); ?>;color:<?php echo e($muted2); ?>;font-size:12px;font-weight:800;">Status</td>
                  <td style="padding:14px 14px;border-bottom:1px solid <?php echo e($stroke2); ?>;color:<?php echo e($text); ?>;font-weight:900;font-size:13px;">
                    <?php echo e($statusLabel); ?>
                ...
                <tr>
                  <td style="padding:14px 14px;color:<?php echo e($muted2); ?>;font-size:12px;font-weight:800;">Date &amp; time</td>
...
</html><?php /**PATH /home/homefor1/scalpchain.com/account/resources/views/emails/withdrawal/request.blade.php ENDPATH**/ ?>