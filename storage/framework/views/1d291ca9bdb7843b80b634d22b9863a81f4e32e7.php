...
<div class="min-h-screen bg-gray-900 relative overflow-hidden">
    ...
    Access your on-chain governance & staking dashboard
</p>
...
<div class="flex items-center justify-center gap-6 mt-6 text-xs sm:text-sm">
    <div class="text-center">
        ...
        <div class="text-gray-400">DAO Markets</div>
    </div>
    ...
    <div class="text-center">
        ...
        <div class="text-gray-400">Yield Execution</div>
    </div>
    ...
    <div class="text-center">
        ...
        <div class="text-gray-400">Protocol Layer</div>
    </div>
</div>
...
<?php echo $__env->make('layouts.guest1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kriprand/radexchain.com/account/resources/views/auth/login.blade.php ENDPATH**/ ?>