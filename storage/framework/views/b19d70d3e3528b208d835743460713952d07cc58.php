                ...
                <div class="mt-12 text-center" x-data="{ open: false }">
                    ...
                    <div x-show="open"
                        ...
                        <p class="text-gray-300">
                            At <?php echo e($settings->site_name); ?>, we take data protection very seriously. All user data is encrypted and stored securely. We never share your personal information with third parties without your explicit consent, and we adhere strictly to international data protection regulations.
                        </p>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/check.elitemaxpro.click/resources/views/home/privacy.blade.php ENDPATH**/ ?>