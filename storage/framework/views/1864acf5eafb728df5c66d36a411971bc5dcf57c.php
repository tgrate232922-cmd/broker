...
<head>
  ...
  <title>KYC Update: <?php echo e($headline); ?> | <?php echo e($brand); ?></title>
  <style>
        ...
        <table role="presentation" width="640" cellpadding="0" cellspacing="0" border="0" style="max-width:640px;background:<?php echo e($card); ?>;border:1px solid <?php echo e($border); ?>;border-radius:14px;overflow:hidden;box-shadow:0 14px 38px rgba(3,10,26,.14);">
          ...
          <tr>
            <td style="padding:22px;">
              ...
              <p style="margin:8px 0 0;line-height:1.6;font-size:14px;color:#0b1320;"><?php echo e($intro); ?></p>
            </td>
          </tr>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td style="font-size:14px;color:#0b1320;">
                          Document Type: <strong><?php echo e(strtoupper($kyc->document_type ?? 'N/A')); ?></strong>
                          &nbsp;•&nbsp; Country: <strong><?php echo e($kyc->country ?? 'N/A'); ?></strong>
                        </td>
                        <td align="right">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid <?php echo e($border); ?>;border-radius:12px;overflow:hidden;">
                ...
                <tr>
                  ...
                  <td style="padding:12px 14px;border-bottom:1px solid <?php echo e($border); ?>;color:#0b1320;font-weight:900;font-size:14px;">
                    <?php echo e(optional($posted_at)->format('Y-m-d H:i')); ?>

                  </td>
                </tr>
                <tr>
                  <td style="padding:12px 14px;border-bottom:1px solid <?php echo e($border); ?>;color:<?php echo e($muted); ?>;font-size:12px;font-weight:800;">Name</td>
                  <td style="padding:12px 14px;border-bottom:1px solid <?php echo e($border); ?>;color:#0b1320;font-weight:900;font-size:14px;">
                    <?php echo e($fullName); ?>
                ...
                <tr>
                  <td style="padding:12px 14px;color:<?php echo e($muted); ?>;font-size:12px;font-weight:800;">Email</td>
                  <td style="padding:12px 14px;color:#0b1320;font-weight:900;font-size:14px;">
                    <?php echo e($user->email ?? $kyc->email ?? ''); ?>
