...
@keyframes  checkDraw {
    ...
    <div class="text-center mb-8">
        <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full
            <?php echo e($withdrawal->status === 'Processed'
                ? 'bg-green-500/20 text-green-400'
                : ($withdrawal->status === 'Rejected'
                    ? 'bg-red-500/20 text-red-400'
                    : 'bg-yellow-500/20 text-yellow-400')); ?>">
            <i data-lucide="clock" class="w-4 h-4"></i>
            <span class="text-sm font-medium"><?php echo e(ucfirst($withdrawal->status)); ?></span>
        </div>
    ...
    <div class="bg-gray-900 border border-gray-800 rounded-2xl p-6 space-y-6">
        ...
        <div class="text-center">
            ...
            <p class="text-3xl font-bold text-white">
                <?php echo e(Auth::user()->currency); ?><?php echo e(number_format($withdrawal->amount, 2)); ?>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            ...
            <div>
                ...
                <p class="text-white font-medium truncate">
                    <?php echo e(\Illuminate\Support\Str::limit($withdrawal->paydetails ?? 'Hidden', 18)); ?>
            ...
            <div>
                ...
                <p class="text-white font-medium">
                    WD-<?php echo e(str_pad($withdrawal->id, 8, '0', STR_PAD_LEFT)); ?>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/homefor1/scalpchain.com/account/resources/views/user/withdrawal_receipt.blade.php ENDPATH**/ ?>