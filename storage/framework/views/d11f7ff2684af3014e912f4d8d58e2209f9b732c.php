                ...
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                            <a href="<?php echo e($settings->site_address); ?>" class="text-gray-400 hover:text-white">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="<?php echo e($settings->site_address); ?>company" class="text-gray-400 hover:text-white ml-1 md:ml-2">Company</a>
                            </div>
                        </li>
                    </ol>
                </nav>
                ...
                <script type="application/ld+json">
                    {
                        ...
                        "itemListElement": [
                            ...
                            },
                            {
                                ...
                                "position": 2,
                                "item": {
                                    "@id": "<?php echo e($settings->site_address); ?>company",
                                    "name": "Company"
                                }
                            }
                        ]
            ...
            <div class="bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-sm rounded-xl p-8 border border-gray-700">
                <div class="space-y-6">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <p class="text-gray-300 leading-relaxed">
                                <?php echo e($settings->site_name); ?> with registration number 709718501 is a company registered under the Laws of Seychelles and is licensed by the Financial Services Authority (FSA) of Seychelles.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <p class="text-gray-300 leading-relaxed">
                                <?php echo e($settings->site_name); ?> is a tradename of <?php echo e($settings->site_name); ?> with registration number HE 19818009, which is registered as a Cyprus Investment Firm (CIF) and licensed by the Cyprus Securities and Exchange Commission (CySEC) in accordance with the Markets In Financial Instruments Directive (MiFID II).
                            </p>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/check.elitemaxpro.click/resources/views/home/regulation.blade.php ENDPATH**/ ?>