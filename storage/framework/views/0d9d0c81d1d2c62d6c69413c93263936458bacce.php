...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8" x-data="myPlansManager()">
    <div class="container mx-auto px-6">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Active Pools</h1>
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
                        <div class="text-center">
                            ...
                            <div class="text-sm text-gray-600 dark:text-gray-400">Total Stakes</div>
                        </div>
                        ...
                        <div class="text-center">
                            ...
                            <div class="text-sm text-gray-600 dark:text-gray-400">Your Total Stakes
<p><small>Across all pools</small></p></div>
                        </div>
                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex flex-wrap items-center gap-4 text-sm">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="text-gray-600 dark:text-gray-400">Staked Amount:</span>
    ...
    <div class="text-center">
        ...
        <?php endif; ?>
        <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">Status</div>
    </div>

    <!-- View Details Button (Platform Color) -->
    <a href="<?php echo e(route('plandetails', $plan->id)); ?>"
       class="group inline-flex items-center gap-2 px-4 py-2
        ...
        <svg class="w-4 h-4 transform transition-transform duration-200 group-hover:translate-x-1"
                        ...
                        <?php if($plan->active == 'yes'): ?>
                            ...
                            <div class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                                <div class="flex items-center justify-between mb-2">
                                    <span class="text-sm font-medium text-gray-700 dark:text-gray-300">Staking Progress</span>
    ...
    <div class="flex flex-col sm:flex-row items-center gap-6">
        ...
        <div class="flex-1 text-center sm:text-left">
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400 mb-2">
                <?php echo e($remainingDays); ?> days remaining of <?php echo e($totalDays); ?> days
            </p>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
                    <div class="text-center py-16">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">No Active Stake Pool Found</h3>
                        <p class="text-gray-600 dark:text-gray-400 max-w-md mx-auto mb-8">
                            You don't have any Active Stake Pool at the moment.
                        </p>
                        <a href="<?php echo e(route('mplans')); ?>"
                           class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-600 hover:from-blue-700 hover:to-blue-700 text-white rounded-xl font-medium transition-all duration-200 shadow-lg hover:shadow-xl">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mt-8">
                ...
                <div class="hidden md:flex justify-center mt-4">
                    <p class="text-sm text-gray-700 dark:text-gray-300">
                        Showing <span class="font-medium"><?php echo e($plans->firstItem()); ?></span> to <span class="font-medium"><?php echo e($plans->lastItem()); ?></span> of <span class="font-medium"><?php echo e($plans->total()); ?></span> Stake Pools
                    </p>
                </div>
            </div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/homefor1/scalpchain.com/account/resources/views/user/myplans.blade.php ENDPATH**/ ?>