...
<?php if(!isset($payment_mode)): ?>
    <script>
        window.location.href = "<?php echo e(route('deposits')); ?>";
    </script>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-lg text-gray-300 max-w-2xl mx-auto">
                Securely deposit funds using <span class="text-blue-400 font-semibold"><?php echo e($payment_mode->name ?? 'Selected Payment Method'); ?></span>
    ...
    <?php echo e($payment_mode->name ?? 'Deposit'); ?>
                                ...
                                <div class="space-y-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p class="text-xs sm:text-sm text-gray-400 break-words"><?php if(isset($amount)): ?>
    Transfer <?php echo e($amount); ?><?php echo e(Auth::user()->currency); ?> to the wallet address
<?php else: ?>
    Transfer the exact amount to the wallet address
<?php endif; ?>
</p>
                                        </div>
                                    </div>
                        ...
                        <div class="space-y-4 sm:space-y-6">
                            ...
                            <div class="relative group">
                                ...
                                <div class="relative bg-white p-4 sm:p-6 rounded-2xl">
                                 <?php if(isset($payment_mode) && !empty($payment_mode->wallet_address)): ?>
...
<button type="button"
        ...
        class="mt-2 sm:mt-0 px-4 py-3 bg-blue-600 hover:bg-blue-700 border border-blue-600 rounded-xl text-white transition-all duration-200 flex items-center justify-center gap-2">
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/homefor1/scalpchain.com/account/resources/views/user/payment.blade.php ENDPATH**/ ?>