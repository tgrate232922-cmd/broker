...
<head>
  ...
  <title>Bot Investment Cancelled | <?php echo e($brand); ?></title>
  <style>
        ...
        <tr>
          <td style="padding:22px;">
            ...
            <p style="margin:8px 0 0;line-height:1.6;font-size:14px;">
              Your investment in <strong><?php echo e($investment->bot->name); ?></strong> has been cancelled.
            </p>
          </td>
        </tr>
          ...
          <td style="padding:0 22px;">
            <table role="presentation" width="100%" style="border:1px solid <?php echo e($border); ?>;border-radius:12px;overflow:hidden;">
              ...
              <tr>
                ...
                <td style="padding:12px 14px;color:#0b1320;font-weight:900;font-size:14px;"><?php echo e(now()->format('Y-m-d H:i')); ?></td>
              </tr>
            </table>
          </td>
        </tr>
...
<?php /**PATH /home/lumenvestasset/public_html/resources/views/emails/bot/investment-cancelled.blade.php ENDPATH**/ ?>