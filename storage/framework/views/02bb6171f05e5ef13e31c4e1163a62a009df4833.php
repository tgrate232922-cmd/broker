...
<div x-data="{ show: true }"
    ...
    <div class="flex items-start justify-between">
        <div class="flex items-start space-x-4">
            ...
            <div class="flex-1 min-w-0">
                <h4 class="text-sm font-semibold text-red-800 mb-1">Governance Tier Upgrade Required</h4>
                <p class="text-sm text-red-700 leading-relaxed mb-3">
                    To continue participating and unlock advanced DAO features, please upgrade to the <span class="font-semibold text-red-800"><?php echo e(Auth::user()->user_plan_upgade); ?></span>.
                governance tier.</p>
                ...
                <a href="<?php echo e(route('mplans')); ?>"
                   class="inline-flex items-center space-x-2 px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-lg transition-all duration-200 shadow-md hover:shadow-lg">
                    ...
                    <span>Unlock Advanced DAO Access</span>
...
<?php endif; ?>
<?php /**PATH /home/kriprand/radexchain.com/account/resources/views/components/notify-alert.blade.php ENDPATH**/ ?>