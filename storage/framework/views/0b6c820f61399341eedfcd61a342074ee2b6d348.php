    ...
    <div class="relative z-10 px-4 py-16 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="text-center">
            ...
            <h1 class="text-3xl font-extrabold tracking-tight text-white sm:text-4xl md:text-5xl">
                <span class="block">About <?php echo e($settings->site_name); ?></span>
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="relative group" x-data="{ hover: false }" @mouseenter="hover = true" @mouseleave="hover = false">
                ...
                <div class="relative bg-gray-800 bg-opacity-80 backdrop-blur-sm rounded-xl overflow-hidden border border-gray-700 p-6 transition-all duration-300 group-hover:border-blue-500 group-hover:shadow-lg group-hover:shadow-blue-900/20 h-full flex flex-col items-center">
                    ...
                    <p class="text-gray-300 text-center">Everybody can become a trader with our easiest to use trading platform. <?php echo e($settings->site_name); ?> is available on all modern platforms: Web, Windows, MacOS, iPhone, iPad and Android.</p>
                </div>
            </div>
...
<section class="py-16 bg-gray-800 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold text-white">Why is <?php echo e($settings->site_name); ?> One of the World's Most Trusted Brands?</h2>
            <div class="w-24 h-1 mx-auto mt-4 rounded-full bg-gradient-to-r from-blue-500 to-teal-400"></div>
        </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/lumenvestasset/demo.lumenvestasset.com/resources/views/home/about.blade.php ENDPATH**/ ?>