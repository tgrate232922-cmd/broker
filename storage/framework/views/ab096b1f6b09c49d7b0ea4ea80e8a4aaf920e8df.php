...
<?php endif; ?>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-400">Reference: DEP-<?php echo e(str_pad($deposit->id, 6, '0', STR_PAD_LEFT)); ?>
            ...
            <div class="p-5 sm:p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="bg-gray-800/30 rounded-2xl p-4 border border-gray-700">
                        ...
                        <p class="text-sm font-semibold text-white mt-1"><?php echo e(auth()->user()->name); ?></p>
                    ...
                    <div class="bg-gray-800/30 rounded-2xl p-4 border border-gray-700">
                        ...
                        <p class="text-sm font-semibold text-white mt-1">
                            <?php echo e(\Carbon\Carbon::parse($deposit->created_at)->format('D, M d, Y h:i A')); ?>

                        </p>
                        <p class="text-xs text-gray-400 mt-1">Receipt ID: #<?php echo e($deposit->id); ?></p>
                    </div>
                </div>
    ...
    <span class="text-sm text-gray-500 dark:text-gray-400">
      ...
      <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium border <?php echo e($badge); ?>">
                        <span class="w-2 h-2 rounded-full <?php echo e(str_contains($badge,'green') ? 'bg-green-400' : (str_contains($badge,'red') ? 'bg-red-400' : 'bg-amber-400')); ?>"></span>
                        <?php echo e($label); ?>
...
<?php echo $__env->make('layouts.dasht', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/homefor1/scalpchain.com/account/resources/views/user/deposit_receipt.blade.php ENDPATH**/ ?>