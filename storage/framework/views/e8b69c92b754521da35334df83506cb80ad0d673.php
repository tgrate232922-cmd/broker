...
} elseif ($_instance->childHasBeenRendered('GEhxK2L')) {
    $componentId = $_instance->getRenderedChildComponentId('GEhxK2L');
    $componentTag = $_instance->getRenderedChildComponentTagName('GEhxK2L');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GEhxK2L');
} else {
    $response = \Livewire\Livewire::mount('admin.theme-display', []);
    $html = $response->html();
    $_instance->logRenderedChild('GEhxK2L', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?><?php /**PATH /home/lumenvestasset/public_html/resources/views/admin/Settings/AppSettings/theme.blade.php ENDPATH**/ ?>