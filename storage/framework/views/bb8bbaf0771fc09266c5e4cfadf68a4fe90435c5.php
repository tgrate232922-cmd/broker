...
} elseif ($_instance->childHasBeenRendered('ESNwIuw')) {
    $componentId = $_instance->getRenderedChildComponentId('ESNwIuw');
    $componentTag = $_instance->getRenderedChildComponentTagName('ESNwIuw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ESNwIuw');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('ESNwIuw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kriprand/radexchain.com/account/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>