                ...
                <nav class="flex" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                            <a href="<?php echo e($settings->site_address); ?>" class="text-gray-400 hover:text-white transition-colors">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="#" class="text-gray-400 hover:text-white ml-1 md:ml-2 transition-colors">cTrader</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
    ...
    "itemListElement": [
        {
            ...
            "position": 1,
            "item": {
                "@id": "<?php echo e($settings->site_address); ?>",
                "name": "<?php echo e($settings->site_name); ?>"
            }
        },
        {
            "@type": "ListItem",
            "position": 2,
            "item": {
                "@id": "<?php echo e($settings->site_address); ?>platforms/ctrader-overview",
                "name": "cTrader"
            }
        },
        {
            ...
            "position": 3,
            "item": {
                "@id": "<?php echo e($settings->site_address); ?>ctrader/trade",
                "name": "Trade"
            }
        }
    ]
    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="group relative">
                <div class="absolute inset-0 bg-gradient-to-r from-blue-500/5 to-emerald-400/5 rounded-xl transition-all duration-300 group-hover:scale-105"></div>
                <div class="relative p-6 bg-gray-800 rounded-xl border border-gray-700 hover:border-blue-500/50 transition-all duration-300">
                    ...
                    <p class="text-gray-300">Featuring the market's sharpest execution, <?php echo e($settings->site_name); ?> Trade cTrader fills your orders in milliseconds without any requotes or price manipulation.</p>
                </div>
            </div>
            ...
            <div class="group relative">
                <div class="absolute inset-0 bg-gradient-to-r from-blue-500/5 to-emerald-400/5 rounded-xl transition-all duration-300 group-hover:scale-105"></div>
                <div class="relative p-6 bg-gray-800 rounded-xl border border-gray-700 hover:border-blue-500/50 transition-all duration-300">
                    <div class="w-16 h-16 mx-auto mb-4 bg-emerald-500/10 rounded-xl flex items-center justify-center">
            ...
            <div class="group relative">
                ...
                <div class="relative p-6 bg-gray-800 rounded-xl border border-gray-700 hover:border-blue-500/50 transition-all duration-300">
                    ...
                    <p class="text-gray-300">Easy to use and navigate, <?php echo e($settings->site_name); ?> Trade cTrader was built with real traders' needs in mind. Trade with <?php echo e($settings->site_name); ?> Trade cTrader and experience its distinct advantage.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative" data-aos="fade-right" data-aos-duration="1200">
                <div class="relative">
                    ...
                    <img src="temp/custom/img/commission-scheme-crypt1t.png" alt="commission-scheme" class="relative rounded-xl shadow-2xl w-full">
                </div>
            </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elitemaxpro/check.elitemaxpro.click/resources/views/home/trade.blade.php ENDPATH**/ ?>