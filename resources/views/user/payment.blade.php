    ...
    <x-success-alert />
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-lg text-gray-300 max-w-2xl mx-auto">
                Securely deposit funds using <span class="text-blue-400 font-semibold">{{ $payment_mode->name ?? 'Selected Payment Method' }}</span>
                                ...
                                <div class="space-y-4 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p class="text-xs sm:text-sm text-gray-400 break-words">@if(isset($amount))
    Transfer {{ $amount }}{{ Auth::user()->currency }} to the wallet address
@else
                        ...
                        <div class="space-y-4 sm:space-y-6">
                            ...
                            <div class="relative group">
                                ...
                                <div class="relative bg-white p-4 sm:p-6 rounded-2xl">
                                 @if(isset($payment_mode) && !empty($payment_mode->wallet_address))
