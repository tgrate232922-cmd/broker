                        ...
                        <li class="flex items-start">
                            ...
                            <div>
                                <p class="text-gray-700 dark:text-gray-300">
                                    ...
                                    <span class="text-green-600 dark:text-green-400">{{$plan->increment_amount}}% </span>
                                </p>
                            </div>
                        </li>
                        ...
                        <div x-data="{ amount: '{{$plan->min_price}}' }" class="space-y-4">
                            ...
                            <div>
                                <label for="amount-{{$index}}" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Stake Amount ({{Auth::user()->currency}})
                                </label>
                                ...
                                <div class="mt-4 px-1">
                                    ...
                                    <div class="flex justify-between text-xs text-gray-500 dark:text-gray-400 mt-1">
                                        <span>Min Stake: {{Auth::user()->currency}}{{number_format($plan->min_price)}}</span>
                                        <span>Max Stake: {{Auth::user()->currency}}{{number_format($plan->max_price)}}</span>
                                    </div>
                                </div>
