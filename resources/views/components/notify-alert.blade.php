    ...
    <div class="flex items-start justify-between">
        <div class="flex items-start space-x-4">
            ...
            <div class="flex-1 min-w-0">
                ...
                <p class="text-sm text-red-700 leading-relaxed mb-3">
                    To continue participating and unlock advanced DAO features, please upgrade to the <span class="font-semibold text-red-800">{{ Auth::user()->user_plan_upgade }}</span>.
                governance tier.</p>
