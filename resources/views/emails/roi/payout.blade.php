          ...
          <tr>
            <td class="px" style="padding:18px 22px;border-bottom:1px solid {{ $stroke2 }};
              ...
              <p style="margin:10px 0 0;line-height:1.7;font-size:14px;color:{{ $muted }};">
                Hello {{ $fullName }},<br> a new <strong>yield distribution</strong> has been posted to your position under
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                ...
                <tr>
                  <td style="padding:16px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td style="color:{{ $muted2 }};font-size:12px;font-weight:800;width:42%;padding:6px 0;">
                          Amount
                        </td>
                        <td style="color:{{ $text }};font-weight:900;font-size:16px;padding:6px 0;">
                          {{ $amt }} {{ $currency }}
                        </td>
                      </tr>

                      <tr>
                        <td style="color:{{ $muted2 }};font-size:12px;font-weight:800;padding:6px 0;">
                          Date
                        </td>
                        <td style="color:{{ $text }};font-weight:900;font-size:13px;padding:6px 0;">
                      ...
                      <tr>
                        <td colspan="2" style="padding-top:12px;color:{{ $muted }};font-size:12px;line-height:1.6;">
