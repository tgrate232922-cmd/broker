...
<body>
  <div class="preheader">
    {{ $isAdmin ? "New deposit submitted by {$userFullName}" : "Deposit receipt created — awaiting validation" }}
  </div>
        ...
        <table role="presentation" class="container" width="640" cellpadding="0" cellspacing="0" border="0"
          ...
          <tr>
            <td class="px" style="padding:18px 22px;border-bottom:1px solid {{ $stroke2 }};
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="color:{{ $text }};font-weight:950;letter-spacing:.35px;font-size:14px;line-height:1.2;">
                    @if(!empty($logoUrl))
                  ...
                  <td align="right">
                    <span style="display:inline-block;padding:6px 10px;border-radius:999px;
                                 ...
                                 color:{{ $chipText }};font-weight:950;font-size:11px;"
                          class="mono">
              ...
              <h1 style="margin:0;font-size:22px;line-height:1.25;color:{{ $text }};font-weight:950;">
                {{ $isAdmin ? 'Processing Deposit…' : 'Processing…' }}
              </h1>
          ...
          <tr>
            <td class="px" style="padding:14px 22px 0 22px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                     style="border:1px solid {{ $stroke2 }};border-radius:16px;background:rgba(17,28,51,.55);">
                <tr>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td align="center" width="33%">
                          ...
                          <div style="margin-top:8px;color:{{ $muted2 }};font-size:11px;font-weight:900;">SUBMITTED</div>
                        </td>
                        <td align="center" width="34%">
                          ...
                          <div style="margin-top:8px;color:{{ $muted2 }};font-size:11px;font-weight:900;">VALIDATING</div>
                        </td>
                        <td align="center" width="33%">
                          <div style="width:36px;height:36px;border-radius:999px;
                                      background:rgba(34,197,94,.12);
                                      border:1px solid rgba(34,197,94,.35);
                                      display:inline-block;line-height:36px;color:{{ $green }};font-weight:950;">3</div>
                          <div style="margin-top:8px;color:{{ $muted2 }};font-size:11px;font-weight:900;">CONFIRMED</div>
                        </td>
                      </tr>
                    </table>
                  </td>
          ...
          <tr>
            <td class="px" style="padding:16px 22px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                     style="border:1px solid {{ $stroke }};border-radius:18px;overflow:hidden;
                            background:
                              ...
                              rgba(17,28,51,.62);">
                <tr>
                  <td style="padding:16px 16px 12px 16px;border-bottom:1px solid {{ $stroke2 }};">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td style="color:{{ $text }};font-weight:950;font-size:16px;">
                          Deposit Receipt
                        </td>
                        <td align="right" class="mono" style="color:{{ $muted2 }};font-size:12px;font-weight:900;">
                          Ref: {{ $refShort }}
                        </td>
                      </tr>
                    </table>
                ...
                <tr>
                  <td style="padding:14px 16px 16px 16px;">
                    <!-- Amount panel -->
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                           style="border:1px solid {{ $stroke2 }};border-radius:16px;background:rgba(11,18,32,.55);">
                      <tr>
                        <td style="padding:16px;text-align:center;">
                          <div style="color:{{ $muted2 }};font-size:12px;font-weight:900;letter-spacing:.25px;">
                            DEPOSIT AMOUNT
                          </div>
                          <div style="margin-top:8px;color:{{ $text }};font-size:38px;font-weight:950;letter-spacing:.2px;">
                            ${{ $amt }}
                          </div>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                           style="border:1px solid {{ $stroke2 }};border-radius:16px;background:rgba(11,18,32,.40);">
                      @if($isAdmin)
                      <tr>
                        <td style="padding:14px 14px;border-bottom:1px solid {{ $stroke2 }};">
                          <div style="color:{{ $muted2 }};font-size:12px;font-weight:900;">USERNAME</div>
                          <div style="margin-top:6px;color:{{ $text }};font-size:14px;font-weight:950;">
                            {{ $userFullName }}
                            <span style="color:{{ $muted2 }};font-weight:800;">&lt;{{ $userEmail }}&gt;</span>
                          </div>
                        </td>
                      </tr>
                      @endif
                      ...
                      <tr>
                        <td style="padding:14px 14px;border-bottom:1px solid {{ $stroke2 }};">
                          <div style="color:{{ $muted2 }};font-size:12px;font-weight:900;">DATE &amp; TIME</div>
                          <div style="margin-top:6px;color:{{ $text }};font-size:14px;font-weight:950;">
                            {{ $submittedText ?: optional($submitted_at)->format('Y-m-d H:i') }}
                          </div>
                          <div class="mono" style="margin-top:6px;color:{{ $muted2 }};font-size:12px;font-weight:900;">
                            Receipt ID: {{ $refShort }}
                          </div>
                        </td>
                      </tr>
                          ...
                          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                              <td style="vertical-align:middle;">
                                <div style="color:{{ $muted2 }};font-size:13px;font-weight:1000;">DEPOSIT STATUS</div>
                                
                              </td>
                              <td align="right" style="vertical-align:middle;">
                                <span style="display:inline-block;padding:8px 12px;border-radius:999px;
                                             background:{{ $chipBg }};border:1px solid {{ $chipBorder }};
                                             color:{{ $chipText }};font-weight:950;font-size:12px;">
                                  ● {{ $statusLabel }}
                                </span>
                              </td>
                            </tr>
                       ...
                       <tr>
                        <td style="padding:14px 14px;">
                          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                              <td style="vertical-align:middle;">
                                <div style="color:{{ $muted2 }};font-size:13px;font-weight:1000;">ASSET</div>
                               
                              </td>
                               <td align="right" style="vertical-align:middle;">
                                <span style="display:inline-block;padding:8px 12px;border-radius:999px;
             background:{{ $chipBg }};border:1px solid {{ $chipBorder }};
             color:{{ $chipText }};font-weight:900;font-size:12px;">
  ● {{ strtoupper((string) ($deposit->payment_mode ?? 'N/A')) }}
</span>
                              </td>
                            </tr>
                          </table>
          ...
          <tr>
            <td class="px" style="padding:0 22px 18px 22px;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                     style="border:1px solid {{ $stroke2 }};border-radius:14px;background:rgba(11,18,32,.35);">
                <tr>
                  <td style="padding:14px 14px;">
                    <div style="color:{{ $muted2 }};font-size:12px;font-weight:900;">SUPPORT</div>
                    <div style="margin-top:8px;color:{{ $muted }};font-size:13px;line-height:1.65;">
                      Need help? Email
                      <a href="mailto:{{ $supportEmail ?? '' }}" style="color:{{ $blue }};text-decoration:underline;font-weight:950;">
