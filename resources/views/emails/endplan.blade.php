{{-- DAO / Staking style completed notice (same style as deposit/withdrawal, no "investment/plan" language) --}}
@php
          ...
          <tr>
            <td class="px" style="padding:18px 22px;border-bottom:1px solid {{ $stroke2 }};
              ...
              <p style="margin:10px 0 0;line-height:1.7;font-size:14px;color:{{ $muted }};">
                Hello {{ $receiverName }}, your DAO pool cycle has completed. A release summary is below.
              </p>
            </td>
          </tr>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      ...
                      <tr>
                        <td colspan="2" style="padding-top:10px;color:{{ $muted2 }};font-size:12px;">
                          Pool status: <span class="mono" style="color:{{ $text }};font-weight:800;">COMPLETED</span>
                        </td>
                      </tr>
                    </table>
                  </td>
