                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control  " placeholder="Increament Amount" type="number"
                                            step="any"  value="{{ $signal->increment_amount }}" name="increment_amount" required>
