...
Route::middleware(['isadmin', '2fa'])->prefix('admin')->group(function () {
    ...
    Route::controller(ManageUsersController::class)->group(function () {
        ...
        Route::get('dashboard/investment-markas/{status}/{id}', 'markinvestmentas')
    ->name('investment.markas');
    Route::get('dashboard/deleteinvestment/{id}', 'deleteinvestment')->name('deleteinvestment');
