...
class CrmController extends Controller
{
    public function addtask(Request $request)
    {
        ...
        try {
            ...
            \Log::error('Failed to send task assignment notification email. Admin: ' . $mailduser->firstName . ' (' . $mailduser->email . '), Task: ' . $request->tasktitle . ', Task ID: ' . $task->id . '. Error: ' . $e->getMessage());
        }
    ...
    public function assign(Request $request)
    {
        ...
        try {
            ...
            \Log::error('Failed to send user assignment notification email. Admin: ' . $name . ' (' . $mailduser->email . '), User ID: ' . $request->user_name . '. Error: ' . $e->getMessage());
        }
