...
class PaymentController extends Controller
{
    ...
    public function addpaymethod(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Payment Method Saved. Visit our website https://codesremedy.com/ for more scripts.');
    }
    ...
    public function deletepaymethod($id)
    {
        ...
        return redirect()->back()->with('success', 'Payment Method Deleted Successfully. or more script or help chat the developer on telegram with https://t.me/Nightcrawlery');
    }
